    ...
    public class Склады : ICSSoft.STORMNET.DataObject
    {
        ...
        public class Views
        {
            ...
            public static ICSSoft.STORMNET.View СкладыE
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладыE", typeof(IIS.Generaciya_novaya.Склады));
                }
            }
            ...
            public static ICSSoft.STORMNET.View СкладыL
            {
                get
                {
                    return ICSSoft.STORMNET.Information.GetView("СкладыL", typeof(IIS.Generaciya_novaya.Склады));
                }
            }
        }
    }
