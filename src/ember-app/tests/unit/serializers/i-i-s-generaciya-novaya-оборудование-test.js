...
moduleForModel('i-i-s-generaciya-novaya-оборудование', 'Unit | Serializer | i-i-s-generaciya-novaya-оборудование', {
  // Specify the other units that are required for this test.
  needs: [
    'serializer:i-i-s-generaciya-novaya-оборудование',
    'service:syncer',
    'transform:file',
    'transform:decimal',
    'transform:guid',
